...
import { Box, Typography, List, ListItemButton, ListItemIcon, ListItemText, Divider, Popover, Button } from "@mui/material";
...
const menuItems = [
  ...
  { text: "Job", icon: <WorkOutlineIcon />, path: "/job" },
  { text: "Events", icon: <EventOutlinedIcon />, path: "/events" },
  { text: "About Me", icon: <PersonOutlineIcon />, path: "/about-me" },
];
const Sidebar = () => {
  ...
  return (
    ...
    >
      {/* LOGO / TITLE */}
      <Box sx={{ p: 3, background: "linear-gradient(135deg, #6879e3 0%, #5a6fd6 100%)", borderBottom: "none" }}>
        <Typography
          fontSize="22px"
          fontWeight="700"
          color="#ffffff"
        ...
        {dynamicMenuItems.map((item) => (
          <ListItemButton
            ...
            sx={{
              ...
              mb: 1.5,
              backgroundColor:
                location.pathname === item.path ? "#f0f4ff" : "transparent",
              borderLeft: location.pathname === item.path ? "3px solid #6879e3" : "none",
              pl: location.pathname === item.path ? "calc(1rem - 3px)" : "1rem",
          ...
          >
            ...
            <Button
              ...
              sx={{
                ...
                padding: "10px 24px",
                borderRadius: "10px",
                boxShadow: "0 8px 16px rgba(220, 38, 38, 0.25), inset 0 -1px 0 rgba(0, 0, 0, 0.1)",
                transition: "all 0.25s cubic-bezier(0.16, 1, 0.3, 1)",
                minWidth: "110px",
                position: "relative",
                border: "none",
                "&:hover:not(:disabled)": {
                  ...
                  boxShadow: "0 12px 24px rgba(220, 38, 38, 0.3), inset 0 -1px 0 rgba(0, 0, 0, 0.1)",
                  transform: "translateY(-2px)",
                },
                "&:active:not(:disabled)": {
                  transform: "translateY(0)",
                  boxShadow: "0 4px 8px rgba(220, 38, 38, 0.25), inset 0 -1px 0 rgba(0, 0, 0, 0.1)",
                },
                "&:disabled": {
                  backgroundColor: "#dc2626",
                  opacity: 0.9,
